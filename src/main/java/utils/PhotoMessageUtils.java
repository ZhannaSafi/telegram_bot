...
public class PhotoMessageUtils {
    public static List<String> savePhotos(ArrayList<org.telegram.telegrambots.meta.api.objects.File> files, String botToken) throws IOException {
        Random random = new Random();
        ArrayList<String> paths = new ArrayList<>();
        for (File file : files) {
            final String imageUrl = "https://api.telegram.org/file/bot" + botToken + "/" + file.getFilePath();
            final String localFileName = "images/" + String.valueOf(new Date(2023).getTime()) + random.nextLong() + ".jpeg";
